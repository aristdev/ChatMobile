    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'Connecté en tant que ${currentUser.login}',
          ),
        ),
...
class _BodyLayoutState extends State<BodyLayout> {
        ...
        children: <Widget>[
          new Container(
            child: new TextField(
                ...
                decoration: new InputDecoration(labelText: 'Rechercher amis'),
                onSubmitted: (value) {
  ...
  Widget _buildDialogButton() {
    ...
    getDescription() {
      if (_isPrivateDialog) {
        return "Créer un groupe de discussion";
      } else {
        return "Créer une conversation privée";
      }
    }
