...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(automaticallyImplyLeading: false, title: Text('Chat ESP')),
      body: LoginPage(),
    );
  }
}
...
//    return Image.asset('assets/images/splash.png');
        ...
        children: <Widget>[
          new Container(
            child: new TextField(
              ...
              decoration: new InputDecoration(labelText: 'Identifiant'),
            ),
          ),
          new Container(
            child: new TextField(
      ...
      return new Container(
        child: new Column(
          children: <Widget>[
            ...
            new TextButton(
              child: new Text('Vous n\'avez pas de compte ? Appuyez ici pour vous inscrire.'),
              onPressed: _formChange,
            ),
            /*new TextButton(
              child: new Text('Supprimer utilisateur?'),
      ...
      return new Container(
        child: new Column(
          children: <Widget>[
            ...
            new TextButton(
              child: new Text('Vous avez un compte? Cliquer ici pour vous connecter.'),
              onPressed: _formChange,
            )
          ],
        ),
  ...
  void _createAccountPressed() {
    print('créer un utilisateur avec $_login et $_password');
    _signInCC(context,
        CubeUser(login: _login, password: _password, fullName: _login));
  }

  void _deleteUserPressed() {
    print('_deleteUserPressed $_login et $_password');
    _userDelete();
  }
